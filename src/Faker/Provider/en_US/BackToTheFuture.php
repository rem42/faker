...
namespace Rem42\Faker\Provider\en_US;

class BackToTheFuture extends \Rem42\Faker\Provider\BackToTheFuture
{
	protected static $name = ['Marty McFly', 'Dr. Emmett Brown', 'Lorraine Baines', 'George McFly', 'Biff Tannen', 'Jennifer Parker', 'Dave McFly', 'Linda McFly', 'Sam Baines', 'Stella Baines', 'Milton Baines', 'Sally Baines', 'Joey Baines', 'Mr. Strickland', 'Skinhead', '3-D', 'Match', 'Marvin Berry', 'Goldie Wilson', 'Mr. Peabody', 'Mark Dixon', 'Lou', 'Red The Bum', 'Einstein'];
	protected static $date = ['November 5, 1955', 'November 12, 1955', 'October 25, 1985', 'October 26, 1985', 'October 21, 2015'];
